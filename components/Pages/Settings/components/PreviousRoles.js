  ...
  const savePresentRoleDetails = async () => {
      ...
      newData = {
        previousRoleDTO: [
          ...data,
          {
            ...
            previousCompanyName: company,
            previousCompanyJoiningDate: date.toISOString().split("T")[0],
            id: nextId,
          },
        ],
      };
    ...
    try {
      const response = await axios.post(
        `${PROFILE_API}/previous-role/save_previous_role_details/${User.ID}`,
        newData,
        {
          headers: {
